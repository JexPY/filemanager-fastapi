...
def authorize_google():
    ...
    googleStorageDriver = cls(os.environ.get(
        'GOOGLE_CLIENT_EMAIL'), os.environ.get('GOOGLE_STORAGE_KEY_FILE'))
...
def upload_video_file_to_google_storage(videoPaths: dict) -> None:
...
def upload_image_file_to_google_storage(imagePaths: dict) -> None:
    googleCloudStorageDriver, container = authorize_google()
